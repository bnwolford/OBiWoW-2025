...
#load the dataspace with the diabetes, weight, and physical activity data frames from NHANES
...
#if you run into an error here, try calling yardstick::spec so that we specify we want the function from the yardstick package instead of another package we have loaded
...
You can read more about evaluating [calibration in tidymodels](https://www.tidymodels.org/learn/models/calibration/) and what to do if your [model is poorly calibrated](https://tidyverse.org/blog/2022/11/model-calibration/).
