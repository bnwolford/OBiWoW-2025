...
We are going to set a global option within the document to define the root directory. This is important so that relative paths execute correctly.
...
[Here](https://bookdown.org/yihui/rmarkdown-cookbook/working-directory.html) is some reading about how the working directories work within R Markdown files. This is importantly for properly reading in and writing out files.
...
#let's look at the first few rows of the dataframe called dat
dat %>% glimpse()
...
#let's inspect the function, glimpse
?glimpse
